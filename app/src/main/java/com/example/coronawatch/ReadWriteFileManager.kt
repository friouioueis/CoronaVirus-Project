...
object ReadWriteFileManager {
    ...
    fun writeWilaya(nContext : Context) {
        ...
        listWilaya.add(Wilaya(1, "أدرار", 27.875179, -0.295720))
        listWilaya.add(Wilaya(2, "الشلف", 36.154816, 1.325696))
        listWilaya.add(Wilaya(3, "الأغواط", 33.800010, 2.890250))
        listWilaya.add(Wilaya(4, "أم البواقي", 35.876549, 7.115390))
        listWilaya.add(Wilaya(5, "بااتنة", 35.3384291, 5.7315453))
        listWilaya.add(Wilaya(6, "بجاية", 36.7511783, 5.0643687))
        listWilaya.add(Wilaya(7, "بسكرة", 34.320341, 4.7246792))
        listWilaya.add(Wilaya(8, "بشار", 31.385726, -2.0115958))
        listWilaya.add(Wilaya(9, "البليدة", 36.4701645, 2.8287985))
        listWilaya.add(Wilaya(10, "البويرة", 36.2316481, 3.9082579))
        listWilaya.add(Wilaya(11, "تمنراست", 24.3753438, 4.3208436))
        listWilaya.add(Wilaya(12, "تبسة", 35.124945, 7.9011735))
        listWilaya.add(Wilaya(13, "تلمسان", 34.881789, -1.316699))
        listWilaya.add(Wilaya(14, "تيارت", 34.8947575, 1.5945792))
        listWilaya.add(Wilaya(15, "تيزي وزو", 36.6816175, 4.237186))
        listWilaya.add(Wilaya(16, "الجزائر", 36.7753606, 3.0601882))
        listWilaya.add(Wilaya(17, "الجلفة", 34.342841, 3.2172531))
        listWilaya.add(Wilaya(18, "جيجل", 36.7292188, 5.9607776))
        listWilaya.add(Wilaya(19, "سطيف", 36.1892751, 5.403493))
        listWilaya.add(Wilaya(20, "سعيدة", 34.743349, 0.2440764))
        listWilaya.add(Wilaya(21, "سكيكدة", 36.7545115, 6.8856255))
        listWilaya.add(Wilaya(22, "سيدي بلعباس", 34.682268, -0.4357555))
        listWilaya.add(Wilaya(23, "عنابة", 36.8982165, 7.7549272))
        listWilaya.add(Wilaya(24, "قالمة", 36.3491635, 7.409499))
        listWilaya.add(Wilaya(25, "قسنطينة", 36.364519, 6.60826))
        listWilaya.add(Wilaya(26, "المدية", 35.9752045, 3.0123504))
        listWilaya.add(Wilaya(27, "مستغانم", 36.0026915, 0.3686867))
        listWilaya.add(Wilaya(28, "المسيلة", 35.1300205, 4.2003107))
        listWilaya.add(Wilaya(29, "معسكر", 35.3978385, 0.2430195))
        listWilaya.add(Wilaya(30, "ورقلة", 30.9980145, 6.7664536))
        listWilaya.add(Wilaya(31, "وهران", 35.7032751, -0.6492976))
        listWilaya.add(Wilaya(32, "البيض", 32.570303, 1.1259581))
        listWilaya.add(Wilaya(33, "إيليزي", 27.8528505, 7.8189636))
        listWilaya.add(Wilaya(34, "برج بوعريريج", 36.095506, 4.6611002))
        listWilaya.add(Wilaya(35, "بومرداس", 36.7358032, 3.6163046))
        listWilaya.add(Wilaya(36, "الطارف", 36.6713563, 8.070134))
        listWilaya.add(Wilaya(37, "تيندوف", 27.543907, -6.2400539))
        listWilaya.add(Wilaya(38, "تيسيمسيلت", 35.7858975, 1.8340957))
        listWilaya.add(Wilaya(39, "الوادي", 33.215441, 7.1553214))
        listWilaya.add(Wilaya(40, "خنشلة", 34.9133455, 6.9059431))
        listWilaya.add(Wilaya(41, "سوق اهراس", 36.1378681, 7.8262426))
        listWilaya.add(Wilaya(42, "تيبازة", 36.5272741, 2.1683687))
        listWilaya.add(Wilaya(43, "ميلة", 36.2502135, 6.1652163))
        listWilaya.add(Wilaya(44, "عين الدفلر", 36.1586843, 2.0842817))
        listWilaya.add(Wilaya(45, "النعامة", 33.2336851, -0.8151958))
        listWilaya.add(Wilaya(46, "عين تيموشنت", 35.3650471, -0.9452807))
        listWilaya.add(Wilaya(47, "غرداية", 32.440827, 3.5618209))
        listWilaya.add(Wilaya(48, "غيليزان", 35.8363185, 0.9118537))
