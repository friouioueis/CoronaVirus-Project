...
class pubFacebook(models.Model):
    ...
    DateFb                          = models.DateTimeField(auto_now=True, verbose_name='date de publication')
...
class pubYoutube(models.Model):
    ...
    DateYt                          = models.DateTimeField(auto_now=True, verbose_name='date de publication')
...
class pubSiteWeb(models.Model):
    ...
    DateSw                          = models.DateTimeField(auto_now=True, verbose_name='date de publication')
