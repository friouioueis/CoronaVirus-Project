    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomUtilisateur', models.CharField(max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idUtilisateurR', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='utilisateur')),
            ],
        ),
        migrations.CreateModel(
            name='infoPersonel',
